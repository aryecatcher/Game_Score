...
import { FIXTURE_IDS } from "@gamechanger/application";
...
function build() {
  const result = createApiApp({ env: loadEnvironment({ NODE_ENV: "test", APP_MODE: "memory", INTERNAL_SERVICE_TOKEN: "test-internal-token" }) });
